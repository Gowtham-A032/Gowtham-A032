...
![Arduino ATmega2560](https://img.shields.io/badge/Arduino-ATmega2560-lightblue?style=for-the-badge&logo=arduino&logoColor=white)
...
![CAN](https://img.shields.io/badge/CAN-Bus-purple?style=for-the-badge)
![ADC/DAC](https://img.shields.io/badge/ADC/DAC-Analog_IO-red?style=for-the-badge)

### **Electronics & Automotive**
![Basic Electronics](https://img.shields.io/badge/Basic-Electronics-orange?style=for-the-badge)
![ADAS](https://img.shields.io/badge/ADAS-Driver_Assistance-blueviolet?style=for-the-badge)
...
## 🚀 Featured Projects
- 🖥️ **8051 Microcontroller Applications** – Drivers, peripheral interfaces, and automation systems.  
- ⚙️ **LPC1768 Cortex-M3 Projects** – Real-time embedded applications and hardware integration.  
- 🔧 **Arduino ATmega2560 Robotics** – Sensor-based automation and control systems.  
- 🚗 **ADAS Modules** – Driver assistance features and automotive electronics.  
